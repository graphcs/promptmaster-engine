...
GUIDANCE_SYSTEM = (
    ...
    "  FLOW TRIGGERS (Ch1 S13-S14, Ch4 S10, Ch6 S3 — one-click advanced techniques):\n"
    ...
    "  - 'Reframe' → Tier 4 meta-move: questions whether the problem is framed correctly (Commanding the Frame, Ch4 S10)\n"
    ...
    "  - 'Check Intent' → AI infers the user's real underlying goal (Shadow Prompt, Ch1 S14)\n"
    "  - 'Confirm Understanding' → AI restates user's goal in own words to verify correct hearing (Clarifying Prompt, Ch6 S3.1)\n"
    "  - 'Analyze My Pattern' → AI observes user's prompting patterns across the session (Mode Switch for Reflection, Ch6 S3.3)\n"
